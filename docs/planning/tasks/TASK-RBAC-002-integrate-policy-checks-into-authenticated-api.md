...
Integrate Policy Checks Into Authenticated Api
...
RBAC-002, RBAC-003, SEC-002

# Objective

Integrate policy checks into authenticated API/service boundaries.
...
- Implement only: Integrate policy checks into authenticated API/service boundaries.
