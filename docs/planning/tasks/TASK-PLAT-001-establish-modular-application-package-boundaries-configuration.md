...
Establish modular application/package boundaries, configuration validation, and API error/correlation conventions.
...
- Implement only: Establish modular application/package boundaries, configuration validation, and API error/correlation conventions.
...
Update the approved platform area, focused interfaces/contracts, tests, and necessary configuration/documentation. Use the structure established by prerequisite tasks; do not invent unrelated application paths or packages.
...
- Integration: cover the changed platform boundary, persistence, queue, storage, provider, or API path as applicable.
...
- [ ] Services accept validated configuration and emit a request ID without sensitive values.
