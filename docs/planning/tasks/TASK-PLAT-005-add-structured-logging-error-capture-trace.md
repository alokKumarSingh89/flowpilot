...
Add Structured Logging Error Capture Trace
...
OBS-001, OBS-005, OBS-006

# Objective

Add structured logging, error capture, trace propagation, and telemetry redaction middleware.
...
- Implement only: Add structured logging, error capture, trace propagation, and telemetry redaction middleware.
...
Yes. After its dependencies are complete, it can run in parallel with: TASK-PLAT-003, TASK-PLAT-004, TASK-PLAT-006.

# Expected Changes

Update the approved observability area, focused interfaces/contracts, tests, and necessary configuration/documentation. Use the structure established by prerequisite tasks; do not invent unrelated application paths or packages.
...
- Integration: cover the changed observability boundary, persistence, queue, storage, provider, or API path as applicable.
...
- [ ] API and worker errors have correlated, sanitized telemetry.
