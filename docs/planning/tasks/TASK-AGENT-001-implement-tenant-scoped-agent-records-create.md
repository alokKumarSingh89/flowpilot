...
Implement Tenant Scoped Agent Records Create
...
AGENT-001, AGENT-002, AGENT-003, AGENT-004, WS-008

# Objective

Implement tenant-scoped agent records, create/update/deactivate, and at-most-one-active support-agent invariant.
...
- Implement only: Implement tenant-scoped agent records, create/update/deactivate, and at-most-one-active support-agent invariant.
...
Yes. After its dependencies are complete, it can run in parallel with: TASK-AI-001, TASK-AI-002, TASK-AI-003, TASK-AI-004.
...
- [ ] Draft/inactive history is retained; no workspace has more than one active agent.
